// A11yQATrainer desktop shell — loads the live Accessibility QA Engineer AI Trainer Platform
...
// Android build in android/a11y-qa-trainer.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/accessibility-qa-ai-trainer/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'A11yQATrainer — Accessibility QA Engineer AI Trainer Platform',
    webPreferences: {
