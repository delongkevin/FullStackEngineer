// AvionicsTest desktop shell — loads the live Avionics Test Systems Engineer
...
// Android build in android/avionics-test.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/avionics-test-systems/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'AvionicsTest — Avionics Test Systems Engineer',
    webPreferences: {
