// OMPlatform desktop shell — loads the live SQL & XML Data Operations Platform
...
// Android build in android/om-platform.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/om-platform/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'OMPlatform — SQL & XML Data Operations Platform',
    webPreferences: {
