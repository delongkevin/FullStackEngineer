// AICodeTrainer desktop shell — loads the live AI Code Training Platform
...
// Android build in android/ai-trainer.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/ai-trainer/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'AICodeTrainer — AI Code Training Platform',
    webPreferences: {
