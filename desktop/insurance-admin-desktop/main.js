// PolicyCore desktop shell — loads the live Insurance Policy Administration System
...
// Android build in android/insurance-app.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/insurance-policy-admin/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'PolicyCore — Insurance Policy Administration System',
    webPreferences: {
