// SITDashboard desktop shell — loads the live System Integration Test Management Dashboard
...
// Android build in android/sit-dashboard.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/sit-dashboard/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'SITDashboard — System Integration Test Management Dashboard',
    webPreferences: {
