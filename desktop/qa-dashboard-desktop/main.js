// QADashboard desktop shell — loads the live Software QA Analyst Platform
...
// Android build in android/qa-dashboard.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/qa-dashboard/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'QADashboard — Software QA Analyst Platform',
    webPreferences: {
