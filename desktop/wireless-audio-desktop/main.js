// WirelessAudio desktop shell — loads the live Wireless Audio Platform
...
// Android build in android/wireless-audio.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/wireless-audio-platform/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'WirelessAudio — Wireless Audio Platform',
    webPreferences: {
