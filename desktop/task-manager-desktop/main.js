// TaskFlow desktop shell — loads the live Task Manager
...
// Android build in android/task-manager.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/task-manager/index.html';
