// ERPWorkbench desktop shell — loads the live Enterprise ERP Workbench
...
// Android build in android/erp-workbench.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/enterprise-erp-workbench/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'ERPWorkbench — Enterprise ERP Workbench',
    webPreferences: {
