// ShopQuick desktop shell — loads the live Online Grocery Order System
...
// Android build in android/order-system.

const { app, BrowserWindow } = require('electron');
const path = require('path');

const PRIMARY_URL = 'https://fullstackengineer.netlify.app/projects/order-system/index.html';
...
function createWindow() {
  const win = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 640,
    title: 'ShopQuick — Online Grocery Order System',
    webPreferences: {
