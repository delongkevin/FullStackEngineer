      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8" aria-labelledby="hero-heading">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <h1 id="hero-heading" className="text-5xl md:text-7xl font-bold theme-text-primary mb-6 animate-fade-in">
              Hi, I'm <span className="theme-accent-text bg-clip-text">Kevin Delong</span>
            </h1>
            <p className="text-xl md:text-2xl theme-text-secondary mb-8 max-w-3xl mx-auto leading-relaxed">
