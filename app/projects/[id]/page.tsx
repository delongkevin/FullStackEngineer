          ...
          <div className="surface-card rounded-xl shadow-lg p-8 mb-8">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-2/3">
                ...
                {(project.androidUrl || project.iosUrl || project.windowsUrl || project.macUrl) && (
                  <div className="mt-4 pt-4 border-t theme-border">
                    <p className="text-sm font-semibold theme-text-secondary mb-3 flex items-center gap-2">
                      <Smartphone size={16} aria-hidden="true" />
                      {(project.androidUrl && isDirectAndroidDownload(project.androidUrl)) || (project.iosUrl && isDirectIosDownload(project.iosUrl)) || project.windowsUrl || project.macUrl
                        ? 'Download the App'
                        : 'Mobile Source Code'}
                    </p>
                    <div className="flex flex-wrap gap-3">
                      ...
                      {project.windowsUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label={`Download the Windows installer for ${project.title}`}
                        >
                          <Download size={16} aria-hidden="true" />
                      ...
                      {project.macUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label={`Download the macOS installer for ${project.title}`}
                        >
                          <Download size={16} aria-hidden="true" />
                    ...
                    {(project.windowsUrl || project.macUrl) && (
                      <p className="text-xs theme-text-tertiary mt-2">
                        Desktop installers are built automatically from the source in this repo — see the{' '}
                        <a href="https://github.com/delongkevin/FullStackEngineer/actions/workflows/release-desktop.yml" target="_blank" rel="noopener noreferrer" className="underline">
                ...
                <div className="space-y-3 mt-4">
                  ...
                  {(project.androidUrl || project.iosUrl || project.windowsUrl || project.macUrl) && (
                    <div>
                      ...
                      <div className="font-medium theme-text-primary flex gap-2 mt-1 flex-wrap">
                        ...
                        {project.windowsUrl && <span className="text-xs px-2 py-1 bg-sky-100 text-sky-700 rounded-full">🪟 Windows</span>}
                        {project.macUrl && <span className="text-xs px-2 py-1 bg-slate-100 text-slate-700 rounded-full">🍏 macOS</span>}
                      </div>
                    </div>
                  )}
                </div>
