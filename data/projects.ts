...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'CAPL script examples with downloadable templates demonstrating UDS diagnostics, DID/RID operations, and CAN message verification workflows',
      ...
      'Live test execution log with real-time streaming of test activities, CAN messages, UDS diagnostics, and result verdicts',
