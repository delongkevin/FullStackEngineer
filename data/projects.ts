...
export const projects: Project[] = [
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/poker-app-debug.apk',
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/medical-iot-monitor-debug.apk',
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/kamps-factory-debug.apk',
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/embedded-video-debug.apk',
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/computer-store-debug.apk',
  ...
  },
  {
    ...
    androidUrl: '/apk-artifacts/book-app-debug.apk',
  ...
  },
  {
    ...
    androidUrl: 'https://github.com/delongkevin/FullStackEngineer/actions/workflows/release-android.yml',
  ...
  {
    id: 29,
    slug: 'adas-camera-test-dashboard',
    title: 'ADAS Camera Software Test Dashboard',
    description: 'Real-time software test dashboard for an ADAS surround-view camera ECU — 5 cameras, 12 USS sensors, automated test case execution with live pass/fail results.',
    fullDescription: 'A professional automotive software test dashboard built for validating an ADAS surround-view camera ECU on a commercial truck platform. The system integrates five camera channels (front, rear, left, right, cargo/truck-bed), twelve ultrasonic parking sensors (USS), and autonomous driving and trailer-assist feature modules. The interactive demo simulates real-time test case execution with animated mock camera feeds, live sensor overlays, test suite management, and a status board tracking pass, fail, in-progress, and not-executed states across all ADAS subsystems.',
    image: '/images/adas-camera-dashboard.png',
    tech: ['Python', 'C', 'C++', 'CAPL', 'CAN/CAN-FD', 'Ethernet', 'OTA', 'AUTOSAR', 'CANoe', 'Vector VH6504', 'RTSP', 'OpenCV', 'UDS DID/RID', 'DoIP', 'HIL/SIL', 'Jenkins CI'],
    liveUrl: '/projects/adas-camera-dashboard/index.html',
    githubUrl: 'https://github.com/delongkevin/FullStackEngineer',
    featured: true,
    category: 'Automotive',
    features: [
      '5-channel surround-view camera monitor: front, rear, left, right, cargo (truck-bed) with animated mock RTSP feeds and resolution/FPS overlays',
      '12-sensor USS parking grid: real-time proximity distance animation, zone coloring (clear/warn/critical), and parking feature test cases',
      'Automated test case runner: 80+ test cases across Camera, USS, Autonomous Driving, and Trailer modules with live pass/fail/in-progress/not-executed status',
      'Test suite navigation: dedicated views for Camera Validation, Parking Assist, Lane Keep Assist, Automatic Emergency Braking, Blind Spot Detection, and Trailer Reverse Assist',
      'Live diagnostic log stream: timestamped CAN/UDS messages, DTC triggers, and ECU heartbeat signals per active test',
      'Diagnostics + transport visibility: DID/RID/DTC workflows over UDS on CAN, CAN-FD, and DoIP Ethernet with OTA campaign health indicators',
      'Results summary dashboard: donut chart totals, per-module coverage bars, defect triage table with severity ratings, and CI export button',
      'Professional dark overlay UI with real-time camera grid switching, mock image artifacts, and status-color-coded test tiles',
    ],
    embeddable: true,
  ...
  {
    id: 30,
    slug: 'can-fd-analyzer',
    title: 'CAN-FD Network Analyzer & Protocol Decoder',
    description: 'Real-time CAN/CAN-FD frame trace with DBC signal decoding, bus load gauge, ECU node monitoring, signal plots, and Vector ASC export.',
    fullDescription: 'A professional automotive CAN-FD network analysis tool simulating live bus traffic across 8 ECU nodes. The dashboard features a scrolling frame trace with decoded DBC signal names, a semicircle bus load gauge, real-time signal waveform plots for RPM/Speed/Throttle/ADAS distance, full byte inspector, and error statistics. Supports 500Kbps CAN and 2Mbps CAN-FD bitrates with fault injection and .asc log export compatible with Vector CANalyzer format.',
    image: '/images/can-fd-analyzer.png',
    tech: ['CAN', 'CAN-FD', 'Ethernet', 'DoIP', 'OTA', 'DBC', 'Vector CANoe', 'AUTOSAR COM', 'JavaScript', 'HTML5 Canvas', 'CSS3'],
    liveUrl: '/projects/can-fd-analyzer/index.html',
    githubUrl: 'https://github.com/delongkevin/FullStackEngineer',
    featured: true,
    category: 'Automotive',
    features: [
      'Live scrolling CAN/CAN-FD frame trace: timestamp, message ID, frame type badge, DLC, hex data, and decoded DBC signal name',
      'Full DBC database with 8 message definitions: ENG_Status, VehDynamics, TransmCtrl, ADAS_Fusion, USS_Data_FD, BCM_Lighting, BattMgmt_FD, OBD2',
      'Semicircle bus load gauge (Canvas), 7-second history area chart, 8 ECU-node status list, and message frequency table',
      'Real-time signal waveform plots for EngineRPM, VehicleSpeed, ThrottlePos, and Lead Object Distance',
      'Raw byte inspector with hex and binary display per byte; CAN error log with 5 error-type counters',
      'Export to Vector .asc format; ID filter, type filter chips (CAN / CAN-FD / ERROR); auto-scroll toggle',
      'Gateway status panel for Ethernet DoIP routing and OTA campaign state (download, verify, rollback readiness)',
    ],
    embeddable: true,
  ...
  {
    id: 31,
    slug: 'hil-test-platform',
    title: 'HIL / SiL Automotive Test Platform',
    description: 'Hardware-in-the-Loop test platform for ADAS ECU validation — NI TestStand-style sequence runner, real-time I/O panel, oscilloscope, fault injection, and requirements traceability.',
    fullDescription: 'A full Hardware-in-the-Loop (HIL) and Software-in-the-Loop (SiL) test execution environment targeting ADAS camera ECU validation. The platform features a NI VeriStand-inspired UI with a live analog/digital I/O monitor, 4-channel oscilloscope canvas for RPM, Speed, Throttle, and Brake signals, a NI TestStand-style animated test sequence runner, fault injection panel (7 hardware faults), a requirements traceability matrix, and a real-time console log with CAPL script editor. Pass/fail verdicts are tracked across 5 test suites covering Camera, USS Parking, ADAS, Trailer Assist, and Power Safety.',
    image: '/images/hil-test-platform.png',
    tech: ['NI VeriStand', 'NI TestStand', 'CAPL', 'CANoe', 'Python', 'CAN', 'CAN-FD', 'Ethernet DoIP', 'OTA', 'UDS DID/RID', 'AUTOSAR', 'HIL', 'SiL', 'HTML5 Canvas', 'JavaScript'],
    liveUrl: '/projects/hil-test-platform/index.html',
    githubUrl: 'https://github.com/delongkevin/FullStackEngineer',
    featured: true,
    category: 'Automotive',
    features: [
      'Animated test sequence runner: 21 test cases across 5 suites (Camera, USS, ADAS, Trailer, Power/Safety) with per-test progress bars and duration display',
      'Live analog I/O monitor: 6 ADC inputs (VBAT, ECU/Camera temp, USS Vcc, Brake, Throttle) and 4 DAC outputs (AEB, LKA torque, ACC, Park buzzer)',
      '4-channel oscilloscope canvas with selectable channels, trigger line, and color-coded signal traces (RPM, Speed, Throttle, Brake)',
      'Fault injection panel: 7 injectable hardware faults (LVDS short, CAN Bus-Off, USS failure, undervoltage, overtemp, LVDS noise, frame corruption)',
      'Diagnostics and update validation suite: DID read, RID routine execution, DTC clear/recheck, and OTA package signature tests',
      'Requirements traceability matrix linking 8 ASIL requirements to test cases with live coverage percentage',
      'Functional/Code/Req coverage progress bars; CAPL script viewer; real-time execution console log; test report generator',
    ],
    embeddable: true,
  ...
  {
    id: 32,
    slug: 'autosar-ecu-diagnostics',
    title: 'AUTOSAR ECU Software Component Studio',
    description: 'AUTOSAR Classic R21-11 ECU development tool — animated SWC composition diagram, BSW stack, UDS/DTC diagnostics, RTE port inspector, and A2L calibration editor.',
    fullDescription: 'A professional AUTOSAR ECU software component development and diagnostics studio targeting a SurroundView Camera ECU. The tool visualizes the full AUTOSAR Classic architecture: an animated SWC composition canvas showing 7 software components connected via RTE, a layered BSW stack from MCAL to Application, a UDS ISO 14229 diagnostic session with DTC freeze-frame viewer, an RTE port inspector showing all provided/required interfaces with live values, and an A2L-style calibration parameter editor with range sliders and NvM write control.',
    image: '/images/autosar-ecu-diagnostics.png',
    tech: ['AUTOSAR Classic', 'AUTOSAR RTE', 'UDS ISO 14229', 'DID/RID', 'DEM', 'DCM', 'DoIP Ethernet', 'OTA', 'NvM', 'MCAL', 'JavaScript', 'HTML5 Canvas', 'CSS3'],
    liveUrl: '/projects/autosar-ecu-diagnostics/index.html',
    githubUrl: 'https://github.com/delongkevin/FullStackEngineer',
    featured: true,
    category: 'Automotive',
    features: [
      'Interactive SWC composition canvas: 7 animated software components (CameraAcq, ImgProcessing, ADAS_Fusion, USSManager, DiagManager, COM Service, MotionSensor) with Bezier RTE port arrows',
      'AUTOSAR BSW stack visualization: 6 layers from MCAL (TC399 TriCore drivers) through ECU abstraction, services (DCM/DEM/NvM), RTE, to application SWCs',
      'UDS ISO 14229 diagnostics: 8 predefined DTCs with freeze-frame data, fault path display, severity indicator, MIL status, and clear-DTC command',
      'Explicit DID and RID workflows: read DID F190/F110, write DID F1A0, and execute RID FF00 routine self-test',
      'RTE port inspector: provided/required/interface ports for 4 SWCs with live signal values (camera resolution, object counts, AEB commands, ego-motion)',
      'A2L-style calibration editor: 10 parameters (AEB distance, LKA torque, SVC blend, USS range, etc.) with range slider, direct numeric input, and NvM write',
      'Live ECU PID monitoring: MCU load, camera temperature, VBAT, CAN bus load, fusion latency, SurroundView FPS with animated polling',
    ],
    embeddable: true,
  ...
  },
  {
    ...
    features: [
      ...
      'Keyboard Navigation Tester: tabindex-ordered focus-order audit with visual highlight and WCAG 2.4.7 compliance report',
      'WCAG 2.1 AA Quick Checklist: 14 criteria across Perceivable, Operable, and Robust with live pass/fail status',
      'Screen Reader Output Simulator: parses HTML snippets and generates realistic screen-reader announcement tree with issue detection',
      'Challenge Designer: author accessibility coding problems with title, difficulty, language, WCAG criteria, constraints, and I/O examples — live preview panel updates in real time',
      'Challenge Library: 8 pre-seeded accessibility challenges (Modal Dialog, Contrast Checker, ARIA Live Region, Skip Nav, Focus Trap, Data Table, Alt Text Generator, WCAG Crawler)',
      'Code Evaluator: static analysis of pasted solutions for ARIA roles, focus management, keyboard handling, and complexity metrics',
      '8-case WCAG-tagged test runner: evaluates role="dialog", aria-modal, accessible name, Escape key, focus trap, programmatic focus, tabindex abuse, and addEventListener usage',
      'AI Feedback Studio: review 3 AI-generated submissions (JS, Python, TypeScript) across 6 scoring dimensions with range sliders and free-form notes',
      'Feedback history table: tracks all submitted reviews with sub ID, scores, overall rating, verdict, and timestamp',
      'Analytics Dashboard: Canvas-rendered WCAG issue distribution bar, severity donut, 12-week quality trend line, and language distribution bar charts',
      'Data Quality Breakdown table: per-WCAG-principle pass rate, average score, critical issue count, and week-over-week trend',
      'Contributor Leaderboard and Activity Feed: ranked contributors with specialty tags and rolling activity log',
    ],
    embeddable: true,
  ...
  },
  {
    ...
    title: 'Insurance Policy Administration System',
    ...
    features: [
      ...
      'RateEngine class: base rate × territory factor × SIC class code multiplier × deductible credit — shows step-by-step premium breakdown per coverage',
      'ACORD 130 XML export: one-click serialization of policy data to ISO-standard XML with syntax highlighting and copy-to-clipboard',
      'JSON Policy export: structured JSON representation of full policy object graph with coverage array, limits, deductibles, and computed premiums',
      'Rate Engine flowchart: CSS visual showing ISO rating algorithm steps (Eligibility → Base Rate → Territory → Class Code → Schedule Mod → Final Premium)',
      'Territory factor table (10 states), SIC class code table (8 codes), and deductible credit schedule with live interactive rate calculator',
      'Bureau Forms library: 10 ISO/ACORD forms (CG 00 01 04 13, CA 00 01 10 13, CP 00 10 10 12, WC 00 00 00 A, etc.) with edition dates and form types',
      'Form XML schema preview: click any form to see its ACORD XML structure; edition diff viewer shows side-by-side changes between form editions',
      'JSON Schema Explorer: ISO form JSON schema with type annotations; mock form validation with per-field checkmarks',
      'Architecture diagram: CSS Clean Architecture layers (Domain Entities → Application Services → Infrastructure Repositories → Presentation Controllers)',
      'SOLID cards: 5 principles with C# insurance domain code examples (PolicyPremiumCalculator SRP, AbstractCoverage OCP, CommercialAutoPolicy LSP, IRatable/IPersistable ISP, PolicyService DIP)',
      'Design pattern cards: Strategy (per-LOB rating algorithm), Factory (policy object creation), Repository (data access abstraction), Observer (policy event notifications)',
      'API Studio: 7 REST endpoints (GET/POST /policies, GET/PUT /policies/{id}, POST /policies/{id}/rate, GET /forms, POST /forms/validate) with Try-It panels and 600ms mock responses',
    ],
    embeddable: true,
  ...
  },
  {
    ...
    title: 'AI-Driven Automotive Testing Strategy Platform',
    description: 'Comprehensive AI-driven automotive software testing platform with dSPACE HIL, CANoe, Python automation, CAPL scripting, test coverage analysis, AI model validation, defect tracking, and team performance analytics.',
    ...
    category: 'Automotive',
    features: [
      'Real-time HIL test execution dashboard with dSPACE integration showing live test case status, pass/fail verdicts, and execution times',
      'Comprehensive test coverage analysis tracking Camera Systems (85%), ADAS Features (92%), AI Models (78%), Data Pipelines (95%), CAN Networks (88%), and ECU Diagnostics (91%)',
      'AI model validation metrics including Object Detection (98.7% mAP), Lane Detection (96.3% IoU), 12.4ms inference time, and 80.6 FPS performance tracking',
      'Test suite control panel for ADAS, Camera, and CAN test suites with real-time progress tracking (850/1,247 tests executed)',
      'Automated test script generator supporting Python, CAPL, and JavaScript for ADAS Lane Keep Assist, Camera Object Detection, CAN Message Validation, ECU Diagnostics, and AI Model Performance testing',
      'Industry-standard tool integration: dSPACE HIL (connected), CANoe (active), CANape (running), DIVA (online), Python pytest (ready), and JavaScript automation (ready)',
      'CAPL script example with downloadable UDS template demonstrating DID 0xF190 validation, RID routine checks, and CAN message verification workflows',
      'Data pipeline validation tracking with training dataset quality (94%), validation set integrity (97%), and edge case coverage (82%) with analytics tools (TensorBoard, MLflow, Weights & Biases)',
      'Defect tracking system with 127 total defects, 95 resolved, 13 critical pending, 2.3 day average resolution time, and 74.8% resolution rate',
      'Team performance analytics with ISTQB certification tracking (8/10 certified), IREB certification (5/10), and innovation metrics showing +42% efficiency from AI-driven test generation',
      'Coalition Alignment Command Board with milestone progression and role ownership cards to demonstrate cross-functional coordination and delivery leadership',
      'Test execution trend analysis over 30 days showing progression from 850 to 1,247 tests executed with 94.2% pass rate',
      'Export capabilities for PDF reports, Excel data, CSV exports, and ISO 26262 compliance documentation',
      'Live test execution log with timestamped CAN verification, UDS DID/RID diagnostics, and verdict updates during active suite runs',
      'Interactive charts and visualizations using Chart.js for AI performance trends, defect distribution, test coverage by module, and execution statistics',
    ],
    embeddable: true,
