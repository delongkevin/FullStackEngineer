    ...
    <footer className="py-10 sm:py-12" aria-label="Site footer" style={{ background: 'var(--surface-1)', color: 'var(--text-1)', borderTop: '1px solid var(--border-soft)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t theme-border mt-8 pt-8 text-center theme-text-secondary">
          <p><a href="/admin/blog/" className="focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500" style={{ color: 'inherit' }} aria-label="Open private blog editor">&copy;</a> <a href="/admin/comments/" className="focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500" style={{ color: 'inherit' }} aria-label="Open private comment moderation">{new Date().getFullYear()}</a> Kevin Douglas Delong. All rights reserved.</p>
